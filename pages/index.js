...
export function MakeHome(shouldShowAccounts) {
    return (
            ...
            <main>
                ...
                <section className={styles.covid19}>
                    <p className={styles.covid19Guide}>
                        ...
                        <br/><br/>
                        안녕하세요, 서자영·황성현입니다.<br/>
                        코로나19로 뒤숭숭한 요즘, 결혼식 날짜가 다가올수록 저희 역시 결혼식 진행 여부를 두고 고민이 많았습니다.
                        하지만 언제쯤 상황이 나아질지 짐작하기 어려워 결혼식을 미루지 않고 예정대로 진행하기로 했습니다.
                        <br/><br/>
                        많은 분의 축하 속에 결혼식을 올리고 싶었으나,
                        결혼식 당일이 <a href="http://news.jtbc.joins.com/article/article.aspx?news_id=NB11971595">추석 특별방역 기간</a>인 탓에
                        가족들만 모시고 결혼식을 진행하게 되었습니다.
                        <br/><br/>
                        결혼식에 직접 참석하지 못하시더라도 마음 가득 저희를 축복해 주시기 바랍니다.
                        전해주시는 축하의 마음만으로도 큰 기쁨이 됩니다.
                        새로운 출발을 축하해 주시는 모든 분께 진심으로 감사드리며 보람 있는 하루하루 보내시기를 기원합니다. 감사합니다.
                    </p>
                    {shouldShowAccounts &&
                ...
                <section className={styles.contact}>
                    ...
                    <ul className={styles.contactHowto}>
                        ...
                        <li>
                            <h3 className={styles.contactHowtoTitle}>인천국제공항에서 오시는 법</h3>
                            <p className={styles.contactHowtoDescription}>
